...
const StepCard: React.FC<StepCardProps> = ({
  ...
  return (
    <div
      className="relative flex flex-col items-center text-center mb-8 md:mb-0 fade-in-section"
      style={{ "--delay": `${stepNumber * 100}ms` } as React.CSSProperties}
    >
      ...
      <div className="container-ally">
        ...
        >
          <h2 className="heading-lg mb-4">
            Como a Ally atua{" "}
            <span className="gradient-text">durante e após a consulta.</span>
          </h2>
        ...
        {/* Extra information */}
        <div
          className="mt-12 p-4 border border-gray-100 rounded-lg bg-gray-50 flex items-start gap-3 max-w-3xl mx-auto fade-in-section"
