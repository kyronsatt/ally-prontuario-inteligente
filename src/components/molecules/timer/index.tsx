...
const Timer: React.FC<TimerProps> = ({ duration, isPaused }) => {
  ...
  return (
    <div className="relative w-fit h-fit flex items-center justify-center">
      ...
      {/* Timer Circle */}
      <div className="relative z-10 w-32 xl:w-52 h-32 xl:h-52 border-4 outline-4 outline-offset-[5px] outline-double outline-white/50 border-white rounded-full flex flex-col items-center justify-center shadow-inner shadow-ally-blue">
