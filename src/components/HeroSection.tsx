        ...
        <div className="flex flex-col-reverse md:flex-row md:items-center justify-between h-full gap-8 md:gap-12">
          ...
          >
            <img
              ...
              className="rounded-tr-[200px] rounded-b-xl rounded-tl-xl w-full md:w-full xl:w-2/3 h-80 md:h-auto max-h-[60vh] object-cover outline outline-[1px] outline-offset-4 outline-ally-blue/40"
            />
          </div>
        </div>
      </div>
