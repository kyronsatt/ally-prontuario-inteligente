...
export function useAnalytics() {
  ...
  const trackPatientEvent = useCallback(
    (action: string, patientId?: string, additionalProps?: EventProperties) => {
  ...
  const trackUserEvent = useCallback(
    (action: string, userId?: string, additionalProps?: EventProperties) => {
  ...
  const trackPageView = useCallback(
    (pageName: string, additionalProps?: EventProperties) => {
  ...
  const trackButtonClick = useCallback(
    (buttonName: string, additionalProps?: EventProperties) => {
  ...
  const trackDownload = useCallback(
    (fileType: string, fileName: string, additionalProps?: EventProperties) => {
  ...
  const trackFeatureUsage = useCallback(
    (featureName: string, additionalProps?: EventProperties) => {
