...
import { FileText, Loader2, ArrowLeft, Printer, Download, Share2 } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-6">
        <h1 className="text-3xl font-bold text-gray-800">Resumo do Atendimento</h1>
      ...
      <Card className="mb-8 border-none shadow-md overflow-hidden">
        <CardHeader className="bg-gradient-to-r from-blue-50 to-blue-100 border-b">
          <div className="flex justify-between items-center">
            <div>
              <CardDescription className="text-sm text-gray-600 mb-1">Paciente</CardDescription>
              <CardTitle className="text-2xl font-semibold">{appointment.patient?.name}</CardTitle>
            </div>
            <div className="text-right">
              <CardDescription className="text-sm text-gray-600 mb-1">Data do atendimento</CardDescription>
      ...
      {viewFormat === 'soap' && appointment.soapNote ? (
        <div className="space-y-6 animate-fade-in print:space-y-4">
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-blue-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-blue-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">S - Subjetivo</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.soapNote.subjective}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-green-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-green-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">O - Objetivo</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.soapNote.objective}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-amber-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-amber-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">A - Avaliação</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.soapNote.assessment}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-purple-400 overflow-hidden">
            ...
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.soapNote.plan}</p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-6 animate-fade-in print:space-y-4">
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-blue-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-blue-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">Queixa Principal</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.anamneseNote.queixaPrincipal}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-indigo-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-indigo-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">História da Doença Atual</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.anamneseNote.historiaDoencaAtual}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-teal-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-teal-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">Antecedentes Patológicos</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.anamneseNote.antecedentesPatologicos}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-cyan-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-cyan-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">Medicações em Uso</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.anamneseNote.medicacoesEmUso}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-orange-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-orange-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">Hábitos de Vida</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.anamneseNote.habitosDeVida}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-emerald-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-emerald-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">Exames Físicos</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.anamneseNote.examesFisicos}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-sky-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-sky-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">Exames Complementares</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.anamneseNote.examesComplementares}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-rose-400 overflow-hidden">
            <CardHeader className="bg-gradient-to-r from-rose-50 to-transparent pb-3">
              <CardTitle className="text-xl text-gray-800">Diagnóstico</CardTitle>
            </CardHeader>
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.anamneseNote.diagnostico}</p>
            </CardContent>
          </Card>
          ...
          <Card className="shadow-sm hover:shadow transition-shadow border-l-4 border-l-violet-400 overflow-hidden">
            ...
            <CardContent className="pt-4">
              <p className="text-gray-700 whitespace-pre-line">{appointment.anamneseNote.conduta}</p>
            </CardContent>
          </Card>
        </div>
      ) : (
        <div className="text-center py-16 bg-gray-50 rounded-lg border border-dashed border-gray-300">
          ...
          <p className="text-gray-400 mt-2">Por favor, inicie um novo atendimento para gerar um relatório</p>
        </div>
      )}
