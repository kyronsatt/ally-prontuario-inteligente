    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow container-ally py-12">
        ...
        <div className="prose mx-auto max-w-3xl">
          ...
          <p className="mb-6">
            Esta Política de Privacidade descreve como a Ally Medical
            Technologies ("Ally", "nós", "nosso" ou "nossa") coleta, usa,
            armazena e compartilha os dados pessoais quando você utiliza nossa
            plataforma de anamnese estruturada ("Serviço"). Ao utilizar nosso
          ...
          <h3 className="text-lg font-medium mt-6 mb-2">
            1.1. Informações do Profissional de Saúde
          </h3>
          ...
          <p>
            Como profissional de saúde, você insere dados de seus pacientes em
            nossa plataforma, que podem incluir:
          </p>
          <ul className="list-disc pl-6 mt-2 mb-4">
          ...
          <ul className="list-disc pl-6 mt-2 mb-6">
            ...
            <li>
              Nossos interesses legítimos, desde que não prevaleçam sobre seus
          ...
          <p>
            Para dados de saúde dos pacientes, você, como profissional de saúde,
            é o controlador desses dados e deve obter o consentimento adequado
            dos pacientes antes de inserir suas informações em nossa plataforma.
          </p>
          ...
          <ul className="list-disc pl-6 mt-2 mb-6">
            <li>
              Com prestadores de serviços que utilizamos para suportar nosso
              Serviço
            </li>
            <li>Para cumprir com uma obrigação legal</li>
            <li>Para proteger e defender nossos direitos ou propriedade</li>
            <li>
              Para prevenir ou investigar possíveis irregularidades relacionadas
              ao Serviço
            </li>
            <li>
          ...
          <p>
            ...
            armazenamento eletrônico é 100% seguro. Implementamos medidas de
            segurança técnicas e organizacionais adequadas para proteger seus
          ...
          <p>
            Retemos seus dados pessoais apenas pelo tempo necessário para os
            propósitos estabelecidos nesta Política de Privacidade. No caso dos
            dados de pacientes, seguimos os prazos de retenção estabelecidos
            pela legislação aplicável para registros médicos.
          </p>
          ...
          <p>
            ...
            e-mail{" "}
            <a
              href="mailto:privacidade@allymed.com.br"
              className="text-ally-blue hover:underline"
            >
              privacidade@allymed.com.br
            </a>
            .
          </p>
          ...
          <p>
            Seus dados podem ser transferidos e mantidos em computadores
            localizados fora do seu estado, província, país ou outra jurisdição
            governamental, onde as leis de proteção de dados podem ser
            diferentes. Garantimos que qualquer transferência internacional de
            dados seja realizada em conformidade com a legislação aplicável.
          </p>
          ...
          <p>
            ...
            periodicamente para verificar se houve alterações. Mudanças nesta
            Política de Privacidade são efetivas quando publicadas nesta página.
          </p>
